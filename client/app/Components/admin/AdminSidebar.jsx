...
export default function AdminSidebar({ activeTab, setActiveTab, admin, onLogout }) {
  return (
    <div className="w-64 bg-white h-screen fixed left-0 top-0 border-r border-taupe-200 shadow-soft">
      {/* Logo Section */}
      <div className="p-6 border-b border-taupe-200 bg-gradient-to-br from-cream-50 to-white">
        <h2 className="text-2xl font-heading text-charcoal-800">
          Adorn Steps
        </h2>
