          ...
          <div className="bg-white rounded-2xl w-full max-w-lg shadow-2xl my-8 mx-auto">
            ...
            <form onSubmit={handleSubmit} className="p-5 sm:p-6 space-y-4">
              ...
              <div className="flex flex-col sm:flex-row gap-3 pt-2">
                <button 
                  type="submit" 
                  className="flex-1 px-4 py-2.5 bg-gray-800 hover:bg-gray-900 text-white rounded-xl font-semibold shadow-md hover:shadow-lg transition-all duration-200 active:scale-95"
                >
